...
5. Alt accounts are not allowed without a given permission from staff.
    ...
    2. You have to give staff a good reason for an alt account.
6. We have zero tolerance for cheating.
    1. Cracked clients are not allowed.
    2. Any Minecraft mod that provides an unfair advantage over other players is prohibited. This includes but is not limited to:\
        a) Xray is not allowed by any means.\
        b) Freecam is not allowed unless:\
            - 1) You have access to Creative or Spectator mode.